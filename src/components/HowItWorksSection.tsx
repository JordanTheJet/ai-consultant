        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <Card className="relative z-10 p-6 text-center hover:shadow-[var(--shadow-card)] transition-all duration-300 bg-gradient-to-br from-card to-secondary/20 border-primary/10">
                {/* Step Number */}
